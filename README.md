...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .filter-tags { padding: 10px 15px; display: flex; flex-wrap: wrap; gap: 8px; border-bottom: 1px solid var(--border); overflow-x: auto; }
        .filter-tag {
        ...
        .map-panel {
            background: var(--white); border-radius: var(--radius); border: 1px solid var(--border);
            overflow: hidden; box-shadow: var(--shadow); position: relative; flex: 1;
        }
        ...
        .modal-window {
            background: var(--white); width: 900px; max-width: 100%; height: 85vh;
        ...
        .modal-nav {
            ...
            display: flex; flex-direction: column; padding-top: 20px; flex-shrink: 0; overflow-y: auto;
        }
        .m-tab {
        ...
        .modal-content { flex: 1; padding: 30px; overflow-y: auto; background: var(--white); -webkit-overflow-scrolling: touch; }
        ...
        @media (max-width: 900px) {
            ...
            .dashboard-grid { 
                flex-direction: column-reverse; /* Map first, sidebar second for better mobile experience */
                height: auto; 
                min-height: auto; 
                margin-top: 20px; 
            }
            ...
            .university-list { max-height: 40vh; } 
            ...
            .modal-window { height: 100vh; max-height: 100vh; width: 100%; border-radius: 0; position: fixed; top: 0; left: 0; }
            .modal-overlay { align-items: flex-start; padding-top: env(safe-area-inset-top); }
            .modal-body { flex-direction: column; height: 100%; }
            .modal-nav { 
                width: 100%; border-right: none; border-bottom: 1px solid var(--border); padding-top: 0; 
                flex-direction: row; overflow-x: auto; white-space: nowrap; height: auto;
            }
            .m-tab { 
            ...
            .modal-content { padding: 15px; flex: 1; overflow-y: auto; }
            ...
            .nav-menu { flex-direction: column; gap: 15px; display: none; position: absolute; top: 100%; left: 0; width: 100%; background: var(--white); padding: 10px; box-shadow: var(--shadow); z-index: 999; }
            .nav-menu.open { display: flex; }
            .burger-menu { display: block; cursor: pointer; font-size: 1.5rem; color: var(--primary); }
            .top-bar { font-size: 0.8rem; padding: 8px 0; }
            .filter-tags { flex-direction: row; gap: 5px; overflow-x: auto; }
        ...
        @media (max-width: 600px) {
            ...
            .map-panel { height: 40vh; min-height: 250px; }
        ...
        .container { height: calc(100vh - env(safe-area-inset-top) - env(safe-area-inset-bottom)); overflow-y: auto; -webkit-overflow-scrolling: touch; }
        .modal-overlay { height: 100vh; overflow: hidden; padding-top: env(safe-area-inset-top); padding-bottom: env(safe-area-inset-bottom); }
        .modal-window { max-height: calc(100vh - env(safe-area-inset-top) - env(safe-area-inset-bottom)); overflow-y: auto; }
...
<body>
    ...
    function initMap() {
        ...
        if (document.getElementById('map')) {
            ...
            // Invalidate size on load and resize for mobile
